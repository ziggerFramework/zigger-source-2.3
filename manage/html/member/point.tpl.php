                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tbl_sment">파이프(|)로 여러 회원 id 입력 가능<br />(ex: member1|member2)</span>
                            </td>
                        </tr>
                        <tr>
                            <td>포인트</td>
                            <td>
                                ...
                                <span class="tbl_sment">음수(-)를 입력하는 경우 포인트 차감</span>
                            </td>
                        </tr>
                        <tr>
                            <td>사유</td>
                            <td>
                                ...
                                <span class="tbl_sment">회원 포인트 내역에 노출</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
